...
<form action="index.php" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data" class="uk-form uk-form-horizontal uk-margin-left uk-margin-right">
    ...
    <div class="uk-grid uk-margin-top">
        <div class="uk-width-1-1">
            <input class="uk-button uk-button-success" border="0" type="button" name="savesbox" id="savesbox" value="<?php echo JText::_("GURU_SAVE_AND_CLOSE"); ?>" onClick="javascript:submitbutton('savesbox');" />
        </div>
    </div>
