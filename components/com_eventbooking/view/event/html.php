...
class EventbookingViewEventHtml extends RADViewHtml
{
	...
	protected function displayForm()
	{
		...
		{
			$mainCategoryId       = $this->input->getInt('main_category_id');
			$additionalCategories = $this->input->get('category_id', [], 'array');
		}
		...
		$lists['discount_groups'] = JHtml::_('access.usergroup', 'discount_groups[]', explode(',', $item->discount_groups),
