	...
	<div class="popbox-dropdown__bd">
		<div class="popbox-dropdown-nav">
							...
							<div class="o-flag__body">
								<div class="popbox-dropdown-nav__post">
									<div class="<?php echo $this->isMobile() ? 't-fs--lg' : '';?>">
										<a href="<?php echo $request->getRequester()->getPermalink();?>"><?php echo $request->getRequester()->getName();?></a>
									</div>
			...
			<div class="is-empty t-text--muted">
				<?php echo $this->html('html.emptyBlock', 'COM_EASYSOCIAL_TOOLBAR_FRIENDS_NO_FRIENDS_YET', 'fa-users', false, false); ?>
			</div>
			<?php } ?>
		</div>
	</div>
