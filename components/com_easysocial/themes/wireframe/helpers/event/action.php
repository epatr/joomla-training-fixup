...
<div class="btn-group" data-es-events-rsvp data-id="<?php echo $event->id; ?>" data-page-reload="<?php echo $forceReload;?>">
...
<?php } else { ?>
	...
	<?php if ($isPending) { ?>
		<a href="javascript:void(0);" class="btn btn-es-default-o btn-sm" data-es-events-withdraw data-id="<?php echo $event->id;?>">
			<i class="fa fa-sign-out"></i>&nbsp; <?php echo JText::_('COM_EASYSOCIAL_EVENTS_GUEST_WITHDRAW'); ?>
		</a>
	<?php } ?>
