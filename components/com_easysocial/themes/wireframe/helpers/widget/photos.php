        ...
        <div class="es-side-embed-lists__item">
            <a href="<?php echo $photo->getPermalink();?>" 
                class="embed-responsive embed-responsive-4by3"
                    ...
                    data-original-title="<?php echo $photo->_('title');?>"
                    data-placement="bottom"
                    data-es-photo="<?php echo $photo->id; ?>"
            >
                <div class="embed-responsive-item"> <img src="<?php echo $photo->getSource('square');?>" alt="<?php echo $this->html('string.escape', $photo->_('title'));?>" /></div>
            </a>
        </div>
        <?php } ?>
    <?php } ?>
