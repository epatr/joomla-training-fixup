...
<a class="btn btn-es-success-o btn-sm" href="javascript:void(0);" data-es-groups-respond-invitation data-id=<?php echo $group->id;?> data-page-reload="<?php echo $forceReload; ?>">
...
<div data-request-sent class="btn-group">
