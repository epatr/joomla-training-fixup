				...
				<div class="o-flag__body o-flag--top">
					...
					<div class="es-noti__meta">
						<ol class="g-list-inline g-list-inline--delimited">
							<li><a href="<?php echo ESR::notifications(array('id' => $item->id, 'layout' => 'route'));?>" class="t-text--muted"><time><?php echo $item->since;?></time></a></li>
						</ol>
					</div>
				</div>
			</div>

			<div role="group" class="btn-group es-noti__item-action">
