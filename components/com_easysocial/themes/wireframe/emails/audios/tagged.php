		...
		<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="padding: 24px; text-align: left;">
					<h1 style="margin: 0; font-family: sans-serif; font-size: 22px; line-height: 27px; color: #666666; font-weight: normal;"><?php echo JText::sprintf('COM_ES_AUDIO_EMAILS_TAGGED_IN_AUDIO_HEADING', $actor); ?></h1>
				</td>
			</tr>
		</table>
	</td>
						...
						<tr>
							<td valign="top" width="100%">
								...
								<p style="color: #999999;line-height:1.5;text-align:left;margin: 0;padding: 0 0 40px;" class="stack-column">
									<?php echo JText::sprintf('COM_ES_AUDIO_EMAILS_TAGGED_IN_AUDIO_CONTENT', '<a href="' . $actorLink . '" style="color:#00aeef; text-decoration:underline;">' . $actor . '</a>');?>
								</p>
							</td>
						</tr>
					</table>
						...
						<tbody>
							<tr>
								<td valign="middle" width="128">
									<a href="<?php echo $audioPermalink;?>">
										<img src="<?php echo $audioThumbnail;?>" alt="<?php echo $this->html('string.escape', $audioTitle);?>" style="vertical-align:middle;" width="128" />
									</a>
								</td>
								...
								<table align="left" style="font-size: 14px;margin: 0 auto 10px 20px; text-align:left;color:#798796" align="">
										<tr>
											<td style="padding: 5px 0;">
												<a href="<?php echo $audioPermalink;?>" style="color: #00aeef;text-decoration:none;"><?php echo $audioTitle;?>
												</a>
											</td>
										</tr>
										<tr>
											<td style="padding: 5px 0;">
												<a href="<?php echo $audioPermalink;?>" style="color:#00aeef;text-decoration:none;"><?php echo JText::_('COM_ES_AUDIO_EMAILS_LISTEN_AUDIO_BUTTON');?> &rarr;</a>
											</td>
										</tr>
									</table>
								</td>
