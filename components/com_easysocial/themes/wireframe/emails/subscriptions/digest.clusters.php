    ...
    <?php foreach($clusters as $cluster) { ?>
        <?php if ($cluster->posts) { ?>
            ...
            <table role="presentation" aria-hidden="true" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:660px;" class="container" bgcolor="#eee">
                <tr>
                    <td>
                        <img style="min-width:560px; display:block; margin:0; padding:0" class="mobileOff" width="560" height="1" src="<?php echo rtrim(JURI::root(), '/'); ?>/media/com_easysocial/images/spacer.gif"/>
                    </td>
                </tr>
            </table>
            <!-- End Divider Decor -->
