        ...
        <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr>
                <td style="padding: 24px; text-align: left;">
                    <h1 style="margin: 0; font-family: sans-serif; font-size: 22px; line-height: 27px; color: #666666; font-weight: normal;"><?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_GROUP_NEW_MILESTONE' ); ?></h1>
                </td>
            </tr>
        </table>
    </td>
                        ...
                        <tr>
                            <td valign="top" width="100%">
                                <p style="color: #999999;line-height:1.5;text-align:left;margin: 0;padding: 0 0 40px;" class="stack-column">
                                    <?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_GROUP_NEW_MILESTONE_CONTENT' , '<a href="' . $userLink . '" style="color:#00aeef;text-decoration:underline;">' . $userName . '</a>' , '<a href="' . $groupLink . '" style="color:#00aeef;text-decoration:underline;">' . $groupName . '</a>');?>
                                </p>
                            </td>
                        </tr>
                    </table>
					<table role="presentation" aria-hidden="true" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:660px;">
						<tr>
							<td style="text-align: left;">
								...
								<?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_GROUP_NEW_MILESTONE_BY' , '<a href="' . $userLink . '" style="text-decoration: underline;color:#00aeef;">' . $userName . '</a>'); ?>
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							<td style="padding: 5px 0;">
                                <a href="<?php echo $permalink;?>" style="color:#00aeef;text-decoration:none;"><?php echo JText::_('COM_EASYSOCIAL_EMAILS_VIEW_MILESTONE_BUTTON');?> &rarr;</a>
                            </td>
						</tr>
					</table>
				</td>
