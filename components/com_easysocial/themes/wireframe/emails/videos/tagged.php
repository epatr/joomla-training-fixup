		...
		<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="padding: 24px; text-align: left;">
					<h1 style="margin: 0; font-family: sans-serif; font-size: 22px; line-height: 27px; color: #666666; font-weight: normal;"><?php echo JText::sprintf( 'COM_EASYSOCIAL_EMAILS_TAGGED_IN_VIDEO_HEADING' , $actor); ?></h1>
				</td>
			</tr>
		</table>
	</td>
						...
						<tbody>
							<tr>
								<td valign="middle" width="128">
									<a href="<?php echo $videoPermalink;?>">
										<img src="<?php echo $videoThumbnail;?>" alt="<?php echo $this->html( 'string.escape' , $videoTitle );?>" style="vertical-align:middle;" width="128" />
									</a>
								</td>
								...
								<table align="left" style="font-size: 14px;margin: 0 auto 10px 20px; text-align:left;color:#798796" align="">
										<tr>
											<td style="padding: 5px 0;">
												<a href="<?php echo $videoPermalink;?>" style="color: #00aeef;text-decoration:none;"><?php echo $videoTitle;?>
												</a>
											</td>
										</tr>
										<tr>
											<td style="padding: 5px 0;">
												<a href="<?php echo $videoPermalink;?>" style="color:#00aeef;text-decoration:none;"><?php echo JText::_('COM_EASYSOCIAL_EMAILS_VIEW_VIDEO');?> &rarr;</a>
											</td>
										</tr>
									</table>
								</td>
