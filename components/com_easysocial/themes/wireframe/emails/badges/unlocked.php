		...
		<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="padding: 24px 24px 10px; font-family: sans-serif; font-size: 13px; line-height: 20px; color: #999999; text-align: left;">
					<p style="margin: 0;"><?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_UNLOCKED_NEW_BADGE' ); ?></p>
				</td>
			</tr>
			<tr>
				<td style="padding: 0px 24px; text-align: left;">
					<h1 style="margin: 0; font-family: sans-serif; font-size: 22px; line-height: 27px; color: #666666; font-weight: normal;"><?php echo JText::sprintf( 'COM_EASYSOCIAL_EMAILS_UNLOCKED_NEW_BADGE_DESC' , $badgeTitle ); ?></h1>
				</td>
			</tr>
		</table>
	</td>
...
<tr>
	<td dir="ltr" bgcolor="#ffffff" height="100%" valign="top" width="100%" style="padding: 20px 24px 24px; font-family: sans-serif; font-size: 14px; color: #555555; text-align: center;">
						...
						<tr>
							<td valign="top" width="100%">
								...
								<p style="color: #999999;line-height:1.5;text-align:left;margin: 0;padding: 0 0 40px;" class="stack-column">
									<?php echo JText::sprintf( 'COM_EASYSOCIAL_EMAILS_UNLOCKED_NEW_BADGE_INFO' , '<span style="color:#00aeef;">' . $badgeTitle . '</span>' );?>
								</p>
							</td>
						</tr>
					</table>
							...
							<tr>
								<td valign="middle" width="64">
									<span style="display:block;width:64px;border-radius:50%; -moz-border-radius:50%; -webkit-border-radius:50%;background:#fff">
										<a href="<?php echo $badgePermalink;?>"><img src="<?php echo $badgeAvatar;?>" alt="<?php echo $this->html( 'string.escape' , $badgeTitle );?>" style="border-radius:50%; -moz-border-radius:50%; -webkit-border-radius:50%;background:#fff;vertical-align:middle;" width="64" height="64"/></a>
									</span>
								</td>
									...
									<table align="left" style="font-size: 14px;margin: 0 auto 10px 20px; text-align:left;color:#798796" align="">
										<tr>
											<td style="padding: 5px 0;">
												<a href="<?php echo $badgePermalink;?>" style="color:#00aeef;text-decoration:none;"><strong><?php echo $badgeTitle;?></strong></a>
											</td>
										</tr>
										<tr>
											<td style="padding: 5px 0;">
										...
										<tr>
											<td style="padding: 5px 0;">
												<a href="<?php echo $badgePermalink;?>" style="color:#00aeef;text-decoration:none;"><?php echo JText::_('COM_EASYSOCIAL_EMAILS_VIEW_BADGE');?> &rarr;</a>
											</td>
										</tr>
									</table>
								</td>
		...
		<p style="margin-top: 40px;">
			<?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_BADGES_CHECKOUT_YOUR_ACHIEVEMENTS' );?> <a href="<?php echo FRoute::badges( array( 'external' => true , 'layout' => 'achievements' ) );?>" style="color:#00aeef; text-decoration:underline;"><?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_BADGES_SEE_ALL' ); ?></a>
		</p>
		<!--[if mso]>
		</td>
		</tr>
