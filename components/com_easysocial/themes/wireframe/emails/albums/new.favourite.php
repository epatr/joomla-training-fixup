		...
		<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="padding: 24px 24px 10px; font-family: sans-serif; font-size: 13px; line-height: 20px; color: #999999; text-align: left;">
					<p style="margin: 0;"><?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_NEW_FAVOURITE_ALBUM_OWNER' ); ?></p>
				</td>
			</tr>
			<tr>
				<td style="padding: 0px 24px; text-align: left;">
					<h1 style="margin: 0; font-family: sans-serif; font-size: 22px; line-height: 27px; color: #666666; font-weight: normal;"><?php echo JText::sprintf( 'COM_EASYSOCIAL_EMAILS_NEW_FAVOURITE_ALBUM_OWNER_SUBHEADING' , $posterName ); ?></h1>
				</td>
			</tr>
		</table>
	</td>
						...
						<tbody>
							<tr>
								<td valign="middle" width="128">
									<a href="<?php echo $albumPermalink;?>">
										<img src="<?php echo $albumCover;?>" alt="<?php echo $this->html( 'string.escape' , $albumTitle );?>" style="vertical-align:middle;" width="128" />
									</a>
								</td>
								...
								<table align="left" style="font-size: 14px;margin: 0 auto 10px 20px; text-align:left;color:#798796" align="">
										<tr>
											<td style="padding: 5px 0;">
												<a href="<?php echo $albumPermalink;?>" style="color: #00aeef;text-decoration:none;"><?php echo $albumTitle;?>
												</a>
											</td>
										</tr>
										<tr>
											<td style="padding: 5px 0;">
												<a href="<?php echo $albumPermalink;?>" style="color:#00aeef;text-decoration:none;"><?php echo JText::_('COM_EASYSOCIAL_EMAILS_VIEW_ALBUM');?> &rarr;</a>
											</td>
										</tr>
									</table>
								</td>
