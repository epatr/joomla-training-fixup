        ...
        <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr>
                <td style="padding: 24px; text-align: left;">
                    <h1 style="margin: 0; font-family: sans-serif; font-size: 22px; line-height: 27px; color: #666666; font-weight: normal;"><?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_PAGE_INVITED_HEADING' ); ?></h1>
                </td>
            </tr>
        </table>
    </td>
                        ...
                        <tr>
                            <td valign="top" width="100%">
                                <p style="color: #999999;line-height:1.5;text-align:left;margin: 0;padding: 0 0 40px;" class="stack-column">
                                    <?php echo JText::sprintf( 'COM_EASYSOCIAL_EMAILS_PAGE_INVITED_CONTENT' , '<a href="' . $invitorLink . '" style="color:#00aeef;text-decoration:underline;">' . $invitorName . '</a>' , '<a href="' . $pageLink . '" style="color:#00aeef;text-decoration:underline;">' . $pageName . '</a>' ); ?>
                                </p>
                            </td>
                        </tr>
                    </table>
                            ...
                            <tr>
                                <td valign="top" width="64">
                                    <span style="display:block;width:64px;border-radius:50%; -moz-border-radius:50%; -webkit-border-radius:50%;background:#fff">
                                        <img src="<?php echo $pageAvatar;?>" alt="" style="border-radius:50%; -moz-border-radius:50%; -webkit-border-radius:50%;background:#fff;vertical-align:middle;" width="64" height="64"/>
                                    </span>
                                </td>
                                    ...
                                    <table align="left" style="font-size: 14px;margin: 0 auto 10px 20px; text-align:left;color:#798796" align="">
                                        <tr>
                                            <td style="padding: 5px 0;">
                                                <a href="<?php echo $pageLink;?>" style="color:#00aeef;text-decoration:underline;"><h3 style="margin:0;"><?php echo $pageName;?></h3></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px 0;">
                                                <a href="<?php echo $acceptLink; ?>" style="color:#00aeef;text-decoration:none;"><?php echo JText::_('COM_EASYSOCIAL_EMAILS_PAGE_ACCEPT_INVITATION');?> &rarr;</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
