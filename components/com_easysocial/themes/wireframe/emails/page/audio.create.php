...
<tr>
	<td style="text-align: center;font-size:12px;color:#888">
		...
		<p style="text-align:center;padding: 0 30px;">
			<?php echo JText::sprintf('COM_ES_AUDIO_EMAILS_PAGE_NEW_AUDIO_CONTENT', '<a href="' . $pageLink . '">' . $pageName . '</a>');?>
		</p>
					...
					<table style="margin: 0 auto 10px 20px; text-align:left;" align="">
						<tr>
							<td style="text-align: center;background-color:#f8f9fb;padding: 5px;">
								...
								<?php echo JText::sprintf('COM_ES_AUDIO_EMAILS_NEW_AUDIO_BY', '<a href="' . $pageLink . '" style="text-decoration: none;color:#798796;">' . $pageName . '</a>'); ?>
							</td>
						</tr>
						<tr>
							<td>
