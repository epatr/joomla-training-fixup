...
<div class="o-grid o-grid--2of4">
	<div class="o-grid__cell t-lg-pr--md t-xs-pr--no t-xs-mb--lg">
		<input type="number" class="o-form-control" min="1" max="150" placeholder="<?php echo JText::_('COM_ES_ADVANCED_SEARCH_FROM', true);?>"
			data-start value="<?php echo $this->html('string.escape', $data[0]);?>"
		/>
	</div>

	<div class="o-grid__cell">
		<input type="number" class="o-form-control" name="frmEnd" min="1" max="150" placeholder="<?php echo JText::_('COM_ES_ADVANCED_SEARCH_TO', true);?>"
