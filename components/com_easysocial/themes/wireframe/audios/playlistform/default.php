			...
			<div class="o-form-horizontal">
				<div class="o-form-group">
					...
					<div class="o-control-input">
						<?php echo $this->html('grid.inputbox', 'title', $this->html('string.escape', $list->title), 'title', array('placeholder="' . JText::_('COM_ES_AUDIO_PLAYLIST_FORM_TITLE_PLACEHOLDER') . '"')); ?>
