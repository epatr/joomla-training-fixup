...
class EasySocialControllerProfile extends EasySocialController
{
	...
	public function save()
	{
		...
		$options = array('workflow_id' => $this->my->getProfile()->getWorkflow()->id, 'data' => true, 'dataId' => $this->my->id, 'dataType' => SOCIAL_TYPE_USER, 'visible' => SOCIAL_PROFILES_VIEW_EDIT, 'group' => SOCIAL_FIELDS_GROUP_USER);
		...
		$this->my->updateGoals('completeprofile');
