	...
	var methods = {
		init: function( options ) {
			return this.each( function () {
				...
				// Force a tabindex to allow focusing to work:
				cbselect.container.attr( 'tabindex', 0 );
				...
				cbselect.container.on( 'keyup.cbselect', '.select2-search__field', function() {
					checkSelect2Empty( cbselect );
				}).on( 'click.cbselect', function( e ) {
				...
				cbselect.element.on( 'select2:open.cbselect', function() {
					checkSelect2Empty( cbselect );
