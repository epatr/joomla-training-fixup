		...
		row.each( function( index ) {
			...
			items.each( function() {
				...
				if ( $( this ).attr( 'for' ) || $( this ).attr( 'data-cbrepeat-fallback-for' ) ) {
					...
					var oldForNormalized = $( this ).attr( forAttribute ).replace( /\[[a-zA-Z0-9]+\]$/g, '' ).replace( /__[a-zA-Z0-9]+$/g, '' );
					...
					// Update array usages:
					$( this ).attr( forAttribute, $( this ).attr( forAttribute ).replace( /^(.*)(\[\d+\])(\[\w+\])$/g, '$1[' + index + ']$3' ) );
					// Update underscore usages:
					$( this ).attr( forAttribute, $( this ).attr( forAttribute ).replace( /^(.*__)(\d+)(__\w+)$/g, '$1' + index + '$3' ) );

					var newFor = $( this ).attr( forAttribute );

					$( this ).triggerHandler( 'modified-for', [ oldFor, newFor, index ] );

					var newForNormalized = $( this ).attr( forAttribute ).replace( /\[[a-zA-Z0-9]+\]$/g, '' ).replace( /__[a-zA-Z0-9]+$/g, '' );
				...
				if ( $( this ).attr( 'name' ) || $( this ).attr( 'data-cbrepeat-fallback-name' ) ) {
					...
					var oldNameNormalized = $( this ).attr( nameAttribute ).replace( /\[[a-zA-Z0-9]+\]$/g, '' ).replace( /__[a-zA-Z0-9]+$/g, '' );
					...
					// Update underscore usages:
					$( this ).attr( nameAttribute, $( this ).attr( nameAttribute ).replace( /^(.*__)(\d+)(__\w+)$/g, '$1' + index + '$3' ) );

					var newName = $( this ).attr( nameAttribute );

					$( this ).triggerHandler( 'modified-name', [ oldName, newName, index ] );

					var newNameNormalized = $( this ).attr( nameAttribute ).replace( /\[[a-zA-Z0-9]+\]$/g, '' ).replace( /__[a-zA-Z0-9]+$/g, '' );
					...
					if ( oldNameNormalized !== newNameNormalized ) {
						...
						nameItems.each( function() {
							if ( $( this ).attr( 'name' ) ) {
								...
								var itemNewName = $( this ).attr( 'name' );
