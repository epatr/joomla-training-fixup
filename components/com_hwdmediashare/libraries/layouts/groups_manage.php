...
<div class="btn-toolbar">
  <div class="btn-group">
    <button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('groups.delete')">
      <i class="icon-checkmark"></i> <?php echo JText::_('COM_HWDMS_REMOVE'); ?>
    </button>
  </div>
  <div class="btn-group">
    <button type="button" class="btn" onclick="Joomla.submitbutton('groups.publish')">
      <i class="icon-cancel"></i> <?php echo JText::_('COM_HWDMS_PUBLISH'); ?>
    </button>
  </div>
  <div class="btn-group">
    <button type="button" class="btn" onclick="Joomla.submitbutton('groups.unpublish')">
      <i class="icon-cancel"></i> <?php echo JText::_('COM_HWDMS_UNPUBLISH'); ?>
    </button>
  </div>   
  <?php if ($canAdd): ?>
    <a title="<?php echo JText::_('COM_HWDMS_ADD_GROUP'); ?>" href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=groupform&layout=edit&return=' . $displayData->return); ?>" class="btn"><i class="icon-plus"></i> <?php echo JText::_('COM_HWDMS_ADD_GROUP'); ?></a>
  <?php endif; ?>       
</div>
