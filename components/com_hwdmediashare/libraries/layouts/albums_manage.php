...
<div class="btn-toolbar">
  ...
  <?php if ($canAdd): ?>
    <a title="<?php echo JText::_('COM_HWDMS_ADD_ALBUM'); ?>" href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=albumform&layout=edit&return=' . $displayData->return); ?>" class="btn"><i class="icon-plus"></i> <?php echo JText::_('COM_HWDMS_ADD_ALBUM'); ?></a>
  <?php endif; ?>         
</div>
