	...
	public static function renderActivityHtml($activity)
	{
                ...
                switch ($activity->verb) 
                {
                        case 2: // New Media
                                ...
                                if (isset($item->title))
                                {
                                            $routeuser  = ($app->isAdmin() ? 'index.php?option=com_users&task=user.edit&id=' . $activity->actor : JRoute::_(hwdMediaShareHelperRoute::getUserRoute($activity->actor)));
                        ...
                        case 3: // New Album
                                ...
                                if (isset($item->title))
                                {
                                            ...
                                            $routemedia = ($app->isAdmin() ? 'index.php?option=com_hwdmediashare&task=album.edit&id=' . $activity->action : JRoute::_(hwdMediaShareHelperRoute::getAlbumRoute($item->id . ':' . $item->alias)));
                                            $return =  JText::sprintf(hwdMediaShareActivities::getActivityType($activity), 
                                                                      '<a href="'.$routeuser.'">'.$activity->author.'</a>', 
                                                                      '<a href="'.$routemedia.'">'.$item->title.'</a>');
                                            return $return;
                        ...
                        case 8: // Left Group
                                ...
                                {
                                            $routeuser  = ($app->isAdmin() ? 'index.php?option=com_hwdmediashare&task=user.edit&id=' . $activity->actor : JRoute::_(hwdMediaShareHelperRoute::getUserRoute($activity->actor)));
                                            $routemedia = ($app->isAdmin() ? 'index.php?option=com_hwdmediashare&task=album.edit&id=' . $activity->action : JRoute::_(hwdMediaShareHelperRoute::getGroupRoute($item->id . ':' . $item->alias)));
                                            $return =  JText::sprintf(hwdMediaShareActivities::getActivityType($activity), 
                                                                      '<a href="'.$routeuser.'">'.$activity->author.'</a>', 
                                                                      '<a href="'.$routemedia.'">'.$item->title.'</a>');
                                            return $return;
