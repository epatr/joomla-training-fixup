...
class hwdMediaShareRouterLegacy extends hwdMediaShareRouter
{
	/**
	...
	public function build(&$query)
        {
                ...
                $formViews = array( 'albumform', 'categoryform', 'groupform', 'mediaform', 'playlistform', 'userform' );
                ...
                elseif(in_array($view, $formViews))
                {
                        $segments[] = $view;
                        unset($query['view']);
                }
	...
	public function parse(&$segments)
	{
                ...
                if ($segments[0] == 'albumform' || $segments[0] == 'categoryform' || $segments[0] == 'groupform' || $segments[0] == 'mediaform' || $segments[0] == 'playlistform' || $segments[0] == 'userform')
                {
                        $vars['view'] = $segments[0];
                        return $vars;
                }  
