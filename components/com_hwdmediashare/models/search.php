...
class hwdMediaShareModelSearch extends JModelList
{
	...
	public function getItems()
	{
		...
		if ($keywords)
                {                    
                        ...
                        $this->_model->setState('filter.search', $keywords);
	 ...
	 *
         * @access  public
	 * @return  string  Either 'standard' or 'advanced'.
	 */
	public function getMode()
	{
                ...
                return $app->input->get('mode', 'advanced', 'standard');
	}
