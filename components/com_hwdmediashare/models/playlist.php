...
class hwdMediaShareModelPlaylist extends JModelList
{
	...
	public function getPlaylist($pk = null)
	{
		...
		if ($pk)
		{
                        ...
                        $this->_playlist->tags->getItemTags('com_hwdmediashare.playlist', $this->_playlist->id);
                        ...
                        {   
                                $author = JFactory::getUser($this->_playlist->created_user_id);
                                $this->_playlist->author = (!empty($this->_playlist->created_user_id_alias) ? $this->_playlist->created_user_id_alias : ($config->get('author') == 0 ? $author->name : $author->username));
                        }
                        else
                        {
