...
class hwdMediaShareViewMedia extends JViewLegacy 
{
	...
	protected function _prepareDocument()
	{
		...
		if ($menu && $menu->query['option'] == 'com_hwdmediashare' && $menu->query['view'] == 'media' && $this->params->get('menu-meta_description'))
                {
		...
		if ($menu && $menu->query['option'] == 'com_hwdmediashare' && $menu->query['view'] == 'media' && $this->params->get('menu-meta_keywords'))
                {
