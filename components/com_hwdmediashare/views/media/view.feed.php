...
class hwdMediaShareViewMedia extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		foreach ($this->items as $item)
		{
			...
			$feed->image		= $this->utilities->relToAbs(JRoute::_(hwdMediaShareThumbnails::thumbnail($item)));
                        ...
                        switch ($item->type) 
                        {
                                ...
                                case 2: // Remote
                                        ...
                                        $enclosure = new JFeedEnclosure;
                                        $enclosure->url = $feed->image;
                                        $enclosure->length = '';
                                        $enclosure->type = hwdMediaShareDocuments::getContentType(JFile::getExt($feed->image));
                                        $feed->setEnclosure($enclosure);  
                                break;
                        }
