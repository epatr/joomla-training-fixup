...
?>
<form action="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=playlistmedia&tmpl=component&playlist_id='.$this->playlistId.'&add=1'); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
		...
		<div class="btn-toolbar">
			...
			<div class="btn-group pull-left">
                                <a class="btn btn-info" href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=playlistmedia&tmpl=component&playlist_id='.$this->playlistId.'&add=0'); ?>">
