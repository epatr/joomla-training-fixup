...
<script type="text/javascript">
	...
	{
		if (task == 'channelform.cancel' || document.formvalidator.isValid(document.getElementById('adminForm')))
		{
...
<form action="<?php echo JRoute::_('index.php?option=com_hwdmediashare&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
  <div id="hwd-container" class="<?php echo $this->pageclass_sfx;?>"> <a name="top" id="top"></a>
      ...
      <div class="row-fluid">
        ...
        <div class="span4">
          ...
          <div class="btn-toolbar row-fluid">
            <button type="button" class="btn btn-primary btn-large span12" onclick="Joomla.submitbutton('channelform.save')">
    ...
    <?php echo JHtml::_('bootstrap.startTabSet', 'pane', array('active' => 'channel')); ?>
    <!-- Details -->
    <?php echo JHtml::_('bootstrap.addTab', 'pane', 'channel', JText::_('COM_HWDMS_CHANNEL', true)); ?>
    <fieldset>
