...
class hwdMediaShareViewChannelForm extends JViewLegacy
{
	protected $state;
	...
	protected function _prepareDocument()
	{
		...
		// Define the page heading.                
                ...
                {
                        $this->params->set('page_heading', JText::sprintf('COM_HWDMS_EDIT_CHANNELX', $this->escape($this->item->title)));
                }
                else
                {
                        $this->params->set('page_heading', JText::_('COM_HWDMS_CHANNEL'));
                }
