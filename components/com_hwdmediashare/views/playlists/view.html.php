...
class hwdMediaShareViewPlaylists extends JViewLegacy 
{
	...
	public function display($tpl = null)
	{
		...
		$this->pageclass_sfx = htmlspecialchars($this->params->get('pageclass_sfx'));
                ...
                $this->display = $this->state->get('media.display_playlists', 'details');
	...
	protected function _prepareDocument()
	{
		...
		if ($menu && $menu->query['option'] == 'com_hwdmediashare' && $menu->query['view'] == 'playlists' && $this->params->get('menu-meta_description'))
                {
		...
		if ($menu && $menu->query['option'] == 'com_hwdmediashare' && $menu->query['view'] == 'playlists' && $this->params->get('menu-meta_keywords'))
                {
