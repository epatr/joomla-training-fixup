...
$layout = $this->params->get('lightbox_mode') != 0 ? 'media_details_lightbox' :  'media_details';
?>
  ...
  <div id="hwd-container" class="<?php echo $this->pageclass_sfx;?>"> <a name="top" id="top"></a>
    ...
    <?php if ($this->params->get('groupitem_media_map') != '0') :?>
      <div class="media-group-map">
        <div id="media-group-map-canvas"></div>
      </div>
    <?php endif; ?>     
    <div class="row-fluid">
      <!-- Main Column -->  
      <div class="span<?php echo ($this->params->get('groupitem_group_members') != '0' && $this->params->get('groupitem_group_activity') != '0' && $this->activities) ? 8 : 12; ?>">
      ...
      <?php if ($this->params->get('groupitem_group_members') != '0' || ($this->params->get('groupitem_group_activity') != '0' && $this->activities)) :?>  
      <!-- Side Column -->        
      <div class="span4">       
