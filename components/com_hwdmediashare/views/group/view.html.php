...
class hwdMediaShareViewGroup extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->pageclass_sfx = htmlspecialchars($this->params->get('pageclass_sfx'));
                ...
                // If we are showing the side column then reduce the number of media columns
                if ($this->params->get('groupitem_group_members') != '0' || ($this->params->get('groupitem_group_activity') != '0' && $this->activities))
                {
