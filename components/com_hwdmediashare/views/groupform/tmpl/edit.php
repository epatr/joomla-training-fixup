  ...
  <div id="hwd-container" class="<?php echo $this->pageclass_sfx;?>"> <a name="top" id="top"></a>
    ...
    <fieldset>
      <div class="row-fluid">
        ...
        <div class="span4">
          <img src="<?php echo JRoute::_(hwdMediaShareThumbnails::thumbnail($this->item, 3)); ?>" border="0" class="img-responsive pull-right" alt="<?php echo $this->escape($this->item->title); ?>" /> 
        </div>
      </div>  
    </fieldset> 
    <?php echo JHtml::_('bootstrap.endTab'); ?>
