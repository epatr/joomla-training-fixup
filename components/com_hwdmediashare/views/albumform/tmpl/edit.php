...
<script type="text/javascript">
	...
	{
		if (task == 'albumform.cancel' || document.formvalidator.isValid(document.getElementById('adminForm')))
		{
...
<form action="<?php echo JRoute::_('index.php?option=com_hwdmediashare&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
  <div id="hwd-container" class="<?php echo $this->pageclass_sfx;?>"> <a name="top" id="top"></a>
      ...
      <div class="row-fluid">
        ...
        <div class="span4">
          ...
          <div class="btn-toolbar row-fluid">
            <button type="button" class="btn btn-primary btn-large span12" onclick="Joomla.submitbutton('albumform.save')">
    ...
    <?php echo JHtml::_('bootstrap.startTabSet', 'pane', array('active' => 'album')); ?>
    <!-- Details -->
    <?php echo JHtml::_('bootstrap.addTab', 'pane', 'album', JText::_('COM_HWDMS_ALBUM', true)); ?>
    <fieldset>
    ...
    <fieldset>
      <div class="row-fluid">
        ...
        <div class="span4">
          <img src="<?php echo JRoute::_(hwdMediaShareThumbnails::thumbnail($this->item, 2)); ?>" border="0" class="img-responsive pull-right" alt="<?php echo $this->escape($this->item->title); ?>" /> 
        </div>
      </div>  
    </fieldset> 
    <?php echo JHtml::_('bootstrap.endTab'); ?>
    ...
    <?php foreach($this->item->customfields->fields as $group => $fields) : ?>
      <?php echo JHtml::_('bootstrap.addTab', 'pane', JFilterOutput::stringURLSafe($group), JText::_($group, true)); ?>
      <fieldset>
