...
?>
<form action="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=groupmedia&tmpl=component&group_id='.$this->groupId.'&add=1'); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
		...
		<div class="btn-toolbar">
			...
			<div class="btn-group pull-left">
                                <a class="btn btn-info" href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=groupmedia&tmpl=component&group_id='.$this->groupId.'&add=0'); ?>">
	...
	<table class="table table-striped table-condensed">
		<thead>
			<tr>
                                <th width="1%" class="center">
                                        <?php echo JHtml::_('grid.checkall', 'checkall-toggle', 'COM_HWDMS_CHECK_ALL', 'Joomla.checkAll(this, \'mb\')'); ?>
                                </th>
                                <th>
                                        <a class="label" href="javascript:void(0);" onclick="Joomla.submitbutton('groupmedia.link')">
		...
		<?php foreach ($this->items as $i => $item) : ?>
			<tr class="row<?php echo $i % 2; ?>">
                                <td class="center">
                                        <?php echo JHtml::_('HwdGrid.id', $i, $item->id, 'mb', false, 'mid'); ?>
                                </td>                            
				<td>
