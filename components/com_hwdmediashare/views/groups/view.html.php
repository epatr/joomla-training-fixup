...
class hwdMediaShareViewGroups extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->pageclass_sfx = htmlspecialchars($this->params->get('pageclass_sfx'));
                ...
                $this->display = $this->state->get('media.display_groups', 'details');
	...
	protected function _prepareDocument()
	{
		...
		if ($menu && $menu->query['option'] == 'com_hwdmediashare' && $menu->query['view'] == 'groups')
		{
                        ...
                        $heading = $this->params->get('page_heading', JText::_('COM_HWDMS_GROUPS'));
		}
		else
		{
                        $title = JText::_('COM_HWDMS_GROUPS');
                        $heading = JText::_('COM_HWDMS_GROUPS');
		}
		...
		if ($menu && $menu->query['option'] == 'com_hwdmediashare' && $menu->query['view'] == 'groups' && $this->params->get('menu-meta_description'))
                {
		...
		if ($menu && $menu->query['option'] == 'com_hwdmediashare' && $menu->query['view'] == 'groups' && $this->params->get('menu-meta_keywords'))
                {
