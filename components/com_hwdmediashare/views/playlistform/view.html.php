...
class hwdMediaShareViewPlaylistForm extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		// Define the page heading.                
                if ($app->input->get('view', '', 'word') == 'albumform')
                {
                        if ($this->isNew)
                        {
                                $this->params->set('page_heading', JText::_('COM_HWDMS_NEW_PLAYLIST'));
                        }
                        else
                        {
                                $this->params->set('page_heading', JText::sprintf('COM_HWDMS_EDIT_PLAYLISTX', $this->escape($this->item->title)));
                        }
                }
                else
                {
                        $this->params->set('page_heading', JText::_('COM_HWDMS_PLAYLIST'));
                }
