...
class hwdMediaShareControllerChannelForm extends JControllerForm
{
	/**
	 ...
	 * @var     string
	 */
	protected $view_item = 'channelform';
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		$userId   = $user->get('id');
		$asset    = 'com_hwdmediashare.channel.' . $recordId;
	 ...
	 */
	public function getModel($name = 'channelForm', $prefix = 'hwdMediaShareModel', $config = array('ignore_request' => true))
	{
