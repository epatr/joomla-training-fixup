...
class hwdMediaShareControllerPlaylistForm extends JControllerForm
{
	/**
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		$userId   = $user->get('id');
		$asset    = 'com_hwdmediashare.playlist.' . $recordId;
	 ...
	 */
	public function getModel($name = 'playlistForm', $prefix = 'hwdMediaShareModel', $config = array('ignore_request' => true))
	{
