	...
	public function publish()
	{
		...
		else
		{
			...
			if ($model->publish($cid, $value))
			{
                                ...
                                {
                                        case 'delete':
                                                $this->setMessage(JText::plural($this->text_prefix . '_N_GROUPS_DELETED', count($cid)));
                                        break;
                                        default:
                                                $this->setMessage(JText::plural($this->text_prefix . '_N_GROUPS_'.strtoupper($task).'ED', count($cid)));
                                }
			}
			else
			{
