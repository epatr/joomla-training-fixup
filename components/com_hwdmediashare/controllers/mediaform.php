...
class hwdMediaShareControllerMediaForm extends JControllerForm
{
	/**
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		$userId   = $user->get('id');
		$asset    = 'com_hwdmediashare.media.' . $recordId;
	 ...
	 */
	public function getModel($name = 'mediaForm', $prefix = 'hwdMediaShareModel', $config = array('ignore_request' => true))
	{
	...
	protected function getReturnPage()
	{
		...
		{
                        return hwdMediaShareHelperRoute::getMediaItemRoute($id);
		}
		else
		{
	...
	/**
	 * Method to display the share view.
         * 
         * @access  public
	 * @return  void
	 */
	...
	/**
	 * Method to display the link view.
         * 
         * @access  public
	 * @return  void
	 */
	...
	/**
	 * Method to display the download view.
         * 
         * @access  public
	 * @return  void
	 */
	...
	/**
	 * Method to display the meta view.
         * 
         * @access  public
	 * @return  void
	 */
