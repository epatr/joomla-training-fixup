	...
	public static function getInternalNavigation()
	{
                ...
                {               
                        ...
                        <div class="media-mediamenu">
                            ...
                            <?php else: ?>
                                <ul class="nav nav-pills">
                                    <li class="<?php echo ($view == 'discover' ? 'active ' : false); ?>media-mediamenu-discover"><a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=discover'); ?>"><?php echo JText::_('COM_HWDMS_DISCOVER'); ?></a></li>
                                    <li class="<?php echo (($view == 'media' || $view == 'mediaitem') ? 'active ' : false); ?>media-mediamenu-media"><a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=media'); ?>"><?php echo JText::_('COM_HWDMS_MEDIA'); ?></a></li>
                                    <li class="<?php echo (($view == 'categories' || $view == 'category') ? 'active ' : false); ?>media-mediamenu-categories"><a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=categories'); ?>"><?php echo JText::_('COM_HWDMS_CATEGORIES'); ?></a></li>
                                    <li class="<?php echo (($view == 'albums' || $view == 'album') ? 'active ' : false); ?>media-mediamenu-albums"><a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=albums'); ?>"><?php echo JText::_('COM_HWDMS_ALBUMS'); ?></a></li>
                                    <li class="<?php echo (($view == 'groups' || $view == 'group') ? 'active ' : false); ?>media-mediamenu-groups"><a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=groups'); ?>"><?php echo JText::_('COM_HWDMS_GROUPS'); ?></a></li>
                                    <li class="<?php echo (($view == 'playlists' || $view == 'playlist') ? 'active ' : false); ?>media-mediamenu-playlists"><a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=playlists'); ?>"><?php echo JText::_('COM_HWDMS_PLAYLISTS'); ?></a></li>
                                    <li class="<?php echo (($view == 'users' || $view == 'user') ? 'active ' : false); ?>media-mediamenu-channels"><a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=channels'); ?>"><?php echo JText::_('COM_HWDMS_CHANNELS'); ?></a></li>
                                    <li class="<?php echo ($view == 'upload' ? 'active ' : false); ?>media-mediamenu-upload"><a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=upload'); ?>"><?php echo JText::_('COM_HWDMS_UPLOAD'); ?></a></li>
                                    <li class="<?php echo ($view == 'account' ? 'active ' : false); ?>media-mediamenu-account"><a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=account'); ?>"><?php echo JText::_('COM_HWDMS_MY_ACCOUNT'); ?></a></li>
                                    <li class="<?php echo ($view == 'search' ? 'active ' : false); ?>media-mediamenu-search"><a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=search'); ?>"><?php echo JText::_('COM_HWDMS_SEARCH'); ?></a></li>
                                </ul>
                            <?php endif; ?>
                        </div>
                        <?php
