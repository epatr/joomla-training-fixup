...
class hwdMediaShareHelperRoute
{
	...
	public static function entry()
	{
		...
		$app = JFactory::getApplication();      
                ...
                if (!$config->get('enable_categories') && !$app->input->get('task') && (in_array($app->input->get('view', '', 'word'), array('categories', 'category', 'categoryform')))) $enabled = false;
                if (!$config->get('enable_albums')     && !$app->input->get('task') && (in_array($app->input->get('view', '', 'word'), array('albums', 'album', 'albumform')))) $enabled = false;
                if (!$config->get('enable_groups')     && !$app->input->get('task') && (in_array($app->input->get('view', '', 'word'), array('groups', 'group', 'groupform')))) $enabled = false;
                if (!$config->get('enable_channels')   && !$app->input->get('task') && (in_array($app->input->get('view', '', 'word'), array('channels', 'channel', 'channelform')))) $enabled = false;
                if (!$config->get('enable_playlists')  && !$app->input->get('task') && (in_array($app->input->get('view', '', 'word'), array('playlists', 'playlist', 'playlistform')))) $enabled = false;
