...
function calculateIndividualRegistrationFee(changeTicketQuantity) {
    Eb.jQuery(function ($) {
        $('#btn-submit').attr('disabled', 'disabled');
        $('#ajax-loading-animation').show();
        if ($('input:radio[name^=payment_method]').length) {
        ...
        $.ajax({
            ...
            data: $('select.ticket_type_quantity, #adminForm input[name=\'event_id\'], #adminForm input[name=\'coupon_code\'], #adminForm .payment-calculation input[type=\'text\'], #adminForm .payment-calculation input[type=\'checkbox\']:checked, #adminForm .payment-calculation input[type=\'radio\']:checked, #adminForm .payment-calculation select, #adminForm input.eb-hidden-field:hidden, #tickets_members_information :input'),
            dataType: 'json',
            success: function (msg, textStatus, xhr) {
                $('#btn-submit').removeAttr('disabled');
                $('#ajax-loading-animation').hide();
                ...
                if (($('#amount').length || $('#total_amount').length) && msg.payment_amount == 0) {
...
function calculateGroupRegistrationFee() {
    Eb.jQuery(function ($) {
        ...
        $.ajax({
            ...
            data: $('#adminForm input[name=\'event_id\'], #adminForm input[name=\'coupon_code\'], #adminForm .payment-calculation input[type=\'text\'], #adminForm .payment-calculation input[type=\'checkbox\']:checked, #adminForm .payment-calculation input[type=\'radio\']:checked, #adminForm .payment-calculation select, #adminForm input.eb-hidden-field:hidden'),
            dataType: 'json',
            success: function (msg, textStatus, xhr) {
...
function calculateCartRegistrationFee() {
    Eb.jQuery(function ($) {
        ...
        $.ajax({
            ...
            data: $('#adminForm input[name=\'coupon_code\'], #adminForm .payment-calculation input[type=\'text\'], #adminForm .payment-calculation input[type=\'checkbox\']:checked, #adminForm .payment-calculation input[type=\'radio\']:checked, #adminForm .payment-calculation select, #adminForm input.eb-hidden-field:hidden'),
            dataType: 'json',
            success: function (msg, textStatus, xhr) {
                $('#btn-submit').removeAttr('disabled');
                $('#ajax-loading-animation').hide();
