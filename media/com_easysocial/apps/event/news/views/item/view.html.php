...
class NewsViewItem extends SocialAppsView
{
	...
	public function display($uid = null, $docType = null)
	{
		...
		$url = ESR::apps(array('layout' => 'canvas', 'customView' => 'item', 'uid' => $event->getAlias(), 'type' => SOCIAL_TYPE_EVENT, 'id' => $this->app->getAlias(), 'newsId' => $news->id), false);

		// Apply comments for the article
		$comments = ES::comments($news->id, 'news', 'create', SOCIAL_APPS_GROUP_EVENT, array('url' => $url));
