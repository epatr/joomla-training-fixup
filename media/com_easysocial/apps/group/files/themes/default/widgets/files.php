		...
		<ol class="o-nav o-nav--stacked">
			...
			<li class="o-nav__item">
				...
				<div class="t-text--muted t-fs--sm">
					...
					<span><?php echo JText::sprintf('APP_GROUP_FILES_UPLOADED_BY', $this->html('html.user', $file->user_id, true)); ?></span>
				</div>
			</li>
			<?php } ?>
		</ol>
		<?php } else { ?>
			<?php echo $this->html('widget.emptyBlock', 'APP_GROUP_FILES_EMPTY_FILES'); ?>
		<?php } ?>
	</div>
</div>
