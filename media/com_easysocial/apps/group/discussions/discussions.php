...
class SocialGroupAppDiscussions extends SocialAppItem
{
	...
	public function onNotificationLoad(SocialTableNotification &$item)
	{
		...
		if ($item->cmd == 'group.discussion.reply') {
			$item->title = JText::sprintf('APP_GROUP_DISCUSSIONS_NOTIFICATIONS_REPLIED_DISCUSSION', $actor->getName(), $group->getName());
	...
	public function onPrepareStream(SocialStreamItem &$item, $includePrivacy = true)
	{
		...
		$item->comments = ES::comments($item->contextId, $item->context, $item->verb, SOCIAL_APPS_GROUP_GROUP , array('url' => FRoute::stream(array('layout' => 'item', 'id' => $item->uid))), $item->uid);
