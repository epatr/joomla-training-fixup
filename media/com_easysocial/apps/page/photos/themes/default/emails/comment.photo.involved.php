		...
		<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="padding: 24px; text-align: left;">
					<h1 style="margin: 0; font-family: sans-serif; font-size: 22px; line-height: 27px; color: #666666; font-weight: normal;"><?php echo JText::sprintf('APP_PAGE_PHOTOS_EMAILS_COMMENT_PHOTO_INVOLVED_HEADING' , $actor); ?></h1>
				</td>
			</tr>
		</table>
	</td>
						...
						<tr>
							<td valign="top" width="100%">
								...
								<p style="color: #999999;line-height:1.5;text-align:left;margin: 0;padding: 0 0 40px;" class="stack-column">
									<?php echo JText::sprintf('APP_PAGE_PHOTOS_EMAILS_COMMENT_PHOTO_INVOLVED_CONTENT', $actor, $page);?>
								</p>
							</td>
						</tr>
					</table>
