...
// http://developer.joomla.org/joomlacode-archive/issue-27597.html
...
var MediaManager = this.MediaManager = {
	...
	initialize: function()
	{
		...
		this.tree = new MooTreeControl({ div: 'media-tree_tree', mode: 'folders', grid: true, theme: '../media/system/images/mootree.gif', onClick:
			...
			},{ text: '', open: true, data: { url: 'index.php?option=com_hwdmediashare&task=addmedia.scan&tmpl=component', target: 'folderframe'}});
	...
	setViewType: function(type)
	{
		...
		viewstyle = type;
		var folder = this.getFolder();
		this._setFrameUrl('index.php?option=com_hwdmediashare&task=addmedia.scan&tmpl=component&folder='+folder+'&layout='+type);
	},
