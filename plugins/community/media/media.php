...
<div id="hwd-container">  
  ...
  <p class="pull-right"><strong>1 - <?php echo $this->params->get('count', 6); ?> of <?php echo $this->total; ?></strong></p>
  <a href="<?php echo JRoute::_(hwdMediaShareHelperRoute::getChannelRoute($this->user->id)); ?>" class="btn pull-left">View More</a>
