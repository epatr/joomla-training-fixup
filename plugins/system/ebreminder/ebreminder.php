...
class plgSystemEBReminder extends JPlugin
{
	public function onAfterRender()
	{
		if (file_exists(JPATH_ROOT . '/components/com_eventbooking/eventbooking.php'))
		{
			...
			// Send first reminder
			EventbookingHelperMail::sendReminder($numberEmailSendEachTime, $bccEmail, $this->params);

			// Send second reminder
			EventbookingHelperMail::sendSecondReminder($numberEmailSendEachTime, $bccEmail, $this->params);
		}
