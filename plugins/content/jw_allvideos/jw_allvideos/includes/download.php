...
define('JPATH_BASE', '..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..');
...
// Assign paths
$sitePath = str_replace(DS.'plugins'.DIRECTORY_SEPARATOR.'content'.DIRECTORY_SEPARATOR.'jw_allvideos'.DIRECTORY_SEPARATOR.'includes','',dirname(__FILE__));
...
// Start the process
$pathToSourceFile = JFactory::getApplication()->input->get('file');
...
if (!$getfile) {
	...
	$filepath = $sitePath.DIRECTORY_SEPARATOR.str_replace('/',DS,$getfile);
