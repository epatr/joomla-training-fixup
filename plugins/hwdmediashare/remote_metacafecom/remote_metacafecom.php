...
{    
	...
	public function display($item)
	{
		...
		$plugin = JPluginHelper::getPlugin('hwdmediashare', 'remote_metacafecom');
                ...
                $lang->load('plg_hwdmediashare_remote_metacafecom', JPATH_ADMINISTRATOR, $lang->getTag());
                ...
                {
                        $this->setError(JText::_('PLG_HWDMEDIASHARE_REMOTE_METACAFECOM_ERROR_PLAYBACK_PROBLEM_SEE_ORIGINAL'));
                        return false;
                }
	}
