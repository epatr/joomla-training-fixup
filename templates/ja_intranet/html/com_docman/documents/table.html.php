    ...
    <? foreach ($documents as $document): ?>
        <tr class="docman_item" itemscope itemtype="http://schema.org/CreativeWork">
                        ...
                        <span class="koowa_wrapped_content">
                            ...
                            <span class="moreinfo">
                                ...
                                <span class="info-hits">
                                        ...
                                        <i class="fa fa-download" aria-hidden="true"></i><?= object('translator')->choose(array('{number} download', '{number} downloads'), $document->hits, array('number' => $document->hits)) ?></span>
                                </span>
                                <? endif; ?>
                            </span>
                        </span>
            ...
            <td width="5" class="koowa_table__download k-no-wrap">
                <a class="btn btn-success btn-mini docman_track_download docman_download__button" href="<?= $document->download_link; ?>"
