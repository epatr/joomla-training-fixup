...
<div class="contact<?php echo $this->pageclass_sfx?>" itemscope itemtype="http://schema.org/Person">
	...
	<div class="row <?php echo $this->params->get('presentation_style') ?>-style">
		...
		<div class="col-sm-7  contact-left">
			<div class="contact-form-wrap contact-box">
		...
		<div class="col-sm-5 contact-information">
			<div class="inner">
				...
				<div class="contact-box highlight">	
					...
					<?php if($this->params->get('show_misc')) :?>
				...
				<div class="contact-box">	
					<!-- Contact -->
					<div class="contact-title"><?php  echo '<h3>'. JText::_('COM_CONTACT_DETAILS').'</h3>';  ?></div>
	...
	<?php if ($this->params->get('show_info') && ($this->params->get('presentation_style') != 'plain')) : ?>
		<?php echo $this->loadTemplate('address'); ?>
	<?php endif;?>
