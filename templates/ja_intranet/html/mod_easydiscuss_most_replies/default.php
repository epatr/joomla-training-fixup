		...
		>
                ...
                <div class="m-list--inline m-list--has-divider t-lg-mb-sm">
                    ...
                    <?php if ($params->get('showdate', 1)) { ?>
                        <div class="m-list__item">
                            <?php echo JText::sprintf('MOD_EASYDISCUSS_MOST_REPLIES_POSTED_ON', ED::date($post->created)->format(ED::config()->get('layout_dateformat'))); ?>
                        </div>
                    <?php } ?>
                </div>            	
			    ...
			    <?php if ($post->getTags() && $params->get('showtags', 1)) { ?>
				    ...
				    <?php foreach ($post->getTags() as $tag) { ?>
				        <li class="t-lg-mr--md">
				        	<span class="o-label o-label--default-o"><i class="fa fa-tag"></i> <?php echo $tag->title; ?></span>  
				        </li>
					<?php } ?>
				    </ul>
				<?php } ?>
