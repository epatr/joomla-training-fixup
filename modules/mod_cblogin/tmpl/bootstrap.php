		...
		<div class="userdata">
			<div id="form-login-username" class="control-group">
				<div class="controls">
					<?php if ( in_array( $showUsernameLabel, array( 1, 2, 3, 5 ) ) ) { ?>
						...
						<?php } else { ?>
							<label for="modlgn-username" class="col-form-label">
			...
			<div id="form-login-password" class="control-group">
				<div class="controls">
					<?php if ( in_array( $showPasswordLabel, array( 1, 2, 3, 5 ) ) ) { ?>
						...
						<?php } else { ?>
							<label for="modlgn-passwd" class="col-form-label">
				...
				<div id="form-login-secretkey" class="control-group">
					<div class="controls">
						<?php if ( in_array( $showSecretKeyLabel, array( 1, 2, 3, 5 ) ) ) { ?>
							...
							<?php } else { ?>
								<label for="modlgn-secretkey" class="col-form-label">
			...
			<?php if ( in_array( $showRememberMe, array( 1, 3 ) ) ) { ?>
				<div id="form-login-remember" class="control-group checkbox">
					<label for="modlgn-remember" class="col-form-label"><?php echo htmlspecialchars( CBTxt::T( 'Remember Me' ) ); ?></label>
