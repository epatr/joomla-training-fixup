<?php
/*
 * ARI Quiz User Result Joomla! module
 *
 * @package		ARI Quiz User Result Joomla! module
 * @version		1.0.0
 * @author		ARI Soft
...
?>
	<table class="aq-mod-quizuserresult">
		<?php if ($label): ?>
		<caption><?php echo $label; ?></caption>
		<?php endif; ?>
		<tr>
			<th class="aq-quiz"><?php echo JText::_('MOD_ARIQUIZUSERRESULT_LABEL_QUIZ'); ?></th>
			<th class="aq-point"><?php echo JText::_('MOD_ARIQUIZUSERRESULT_LABEL_POINT'); ?></th>
		</tr>
<?php
		if (!empty($results)):
