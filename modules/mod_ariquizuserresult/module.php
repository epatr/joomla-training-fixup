...
$results = $quizResultsModel->getLastUserResults($userId, $count);

$baseUri = JURI::root(true) . '/modules/mod_ariquizuserresult/assets/';
$doc =& JFactory::getDocument(); 
$doc->addStyleSheet($baseUri . 'css/styles.css');

require JModuleHelper::getLayoutPath('mod_ariquizuserresult');