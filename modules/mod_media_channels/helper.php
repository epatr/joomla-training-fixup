...
class modMediaChannelsHelper extends JViewLegacy 
{
	/**
	 * Class constructor.
	 *
	...
	public function addHead()
	{
		...
		$doc = JFactory::getDocument();
                ...
                {
                        $doc->addStyleSheet(JURI::base( true ) . '/modules/mod_media_channels/css/' . $layout . '.css');
                }
	}
	...
	public function getItems()
	{
		...
		$app = JFactory::getApplication();
                ...
                $model = JModelLegacy::getInstance('Channels', 'hwdMediaShareModel', array('ignore_request' => true));               

                // Populate state (and set the context).
                $model->context = 'mod_media_channels';
		$model->populateState();
		...
		// Set the ordering states.
                $ordering = $this->params->get('list_order_channel', 'a.created DESC');
