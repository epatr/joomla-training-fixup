...
<form action="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=editmedia&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate" enctype="multipart/form-data">
	...
	<div class="form-horizontal">
		...
		<div class="row-fluid">
			...
			<div class="span3">
                            <div class="row-striped">
                                ...
                                <?php endif; ?>
                                <?php if ($this->item->type == 3): ?>
                                <div class="row-fluid">
                                    <div class="span12"><span class="hide"><?php echo $this->form->getLabel('media_type'); ?></span><?php echo $this->form->getInput('media_type'); ?></div>
                                </div>  
                                <?php endif; ?>                                
                                ...
                                <div class="row-fluid">
                                    <div class="span12"><span class="hide"><?php echo $this->form->getLabel('ext_id'); ?></span><?php echo $this->form->getInput('ext_id'); ?></div>
                                </div>  
                                <?php endif; ?>                                 
                                <div class="row-fluid">
                                    <div class="span12">
		...
		<?php $this->set('ignore_fieldsets', array('details', 'publishing', 'thumbnail', 'permissions')); // Joomla 3.4.4 added all fieldsets into this layout, so we want to ignore some.
                echo JLayoutHelper::render('joomla.edit.params', $this); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'thumbnail', JText::_('COM_HWDMS_THUMBNAILS', true)); ?>
                        ...
                        <?php if ($this->item->customthumbnail) : ?>            
                                <img src="<?php echo JRoute::_($this->item->customthumbnail); ?>" border="0" alt="<?php echo $this->escape($this->item->title); ?>" />
                        <?php endif; ?>   
		...
		<?php echo JHtml::_('bootstrap.endTab'); ?>
                ...
                <?php foreach($this->item->customfields->fields as $group => $fields): ?>
                        <?php echo JHtml::_('bootstrap.addTab', 'myTab', JFilterOutput::stringURLSafe($group), JText::_($group, true)); ?>
                ...
                <?php if (!empty($this->item->location)): ?>
                        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'maps', JText::_('COM_HWDMS_MAP', true)); ?>
                                <iframe width="100%" height="550" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=<?php echo $this->config->get('google_maps_api_v3_key', 'AIzaSyAyxMefjQ8yajKyvBTMD9KJq-M6n80CGsw'); ?>&q=<?php echo urlencode($this->item->location); ?>" allowfullscreen></iframe> 
                        <?php echo JHtml::_('bootstrap.endTab'); ?>
                <?php endif; ?>   
                ...
                <?php if ($this->item->type == 8): ?>
                    <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'files', JText::_('COM_HWDMS_STREAM_DATA', true)); ?>
                        <table class="adminlist">
                            <?php echo $this->loadTemplate('streams');?>
                        </table>
                    <?php echo JHtml::_('bootstrap.endTab'); ?> 
                <?php endif; ?>  
