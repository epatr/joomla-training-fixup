...
{      
    if (task == "maintenance.run")
    {
        ...
        post("cleanactivities")
        post("cleanchannels")
    }
    else if (task == "maintenance.bulkallowcommenting")
    {
        jQuery("[id^=ajax-container]").html("")
        post("bulkallowcommenting")
    }   
    else if (task == "maintenance.bulkdenycommenting")
    {
        jQuery("[id^=ajax-container]").html("")
        post("bulkdenycommenting")
    }   
    else if (task == "maintenance.bulkallowlikes")
    {
        jQuery("[id^=ajax-container]").html("")
        post("bulkallowlikes")
    }   
    else if (task == "maintenance.bulkdenylikes")
    {
        jQuery("[id^=ajax-container]").html("")
        post("bulkdenylikes")
    }  
    else if (task == "maintenance.bulkallowembedding")
    {
        jQuery("[id^=ajax-container]").html("")
        post("bulkallowembedding")
    }   
    else if (task == "maintenance.bulkdenyembedding")
    {
        jQuery("[id^=ajax-container]").html("")
        post("bulkdenyembedding")
    }  
    else
    {
