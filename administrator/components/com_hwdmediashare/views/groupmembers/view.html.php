...
class hwdMediaShareViewGroupMembers extends JViewLegacy
{
	...
	public function getButton($row, $i)
	{
                ...
                $text = $row->connection ? 'COM_HWDMS_BTN_REMOVE_MEMBER' : 'COM_HWDMS_BTN_ADD_MEMBER';

                ob_start();
                ?>
                <div class="btn-wrapper pull-right">
                        <a class="<?php echo $class; ?>" href="javascript:void(0);" onclick="return listItemTask('cb<?php echo $i; ?>','groupmembers.<?php echo $task; ?>')"><?php echo JText::_($text); ?></a>
                </div>
                <?php
