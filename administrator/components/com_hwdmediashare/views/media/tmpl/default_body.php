...
<tr class="row<?php echo $i % 2; ?>">
        ...
        <td class="nowrap-todo has-context-todo">
                <div class="pull-right"><span class="editlinktip hasTooltip" title="<?php echo JHtml::tooltipText($this->getMediaType($item)); ?>" ><i class="icon-<?php echo $this->getMediaTypeIcon($item); ?> media-type"></i></div>
