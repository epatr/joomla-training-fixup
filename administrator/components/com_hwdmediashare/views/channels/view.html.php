...
class hwdMediaShareViewChannels extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->document->addStyleSheet(JURI::root() . "media/com_hwdmediashare/assets/css/administrator.css"); 
                ...
                $this->document->addStyleSheet(JURI::root() . "media/com_hwdmediashare/assets/css/magnific-popup.css");
                
                // Load MagnificPopup JS file.
                $this->document->addScript(JURI::root() . "media/com_hwdmediashare/assets/javascript/jquery.magnific-popup.js");

                $script = "
jQuery(document).ready(function(){
  jQuery('#toolbar-new').magnificPopup({
    items: {
      src: '" . JRoute::_('index.php?option=com_hwdmediashare&view=channels&layout=add&tmpl=component', false) . "'
    },
    type: 'iframe'  
  });  
