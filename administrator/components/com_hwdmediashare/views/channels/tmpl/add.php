...
?>
<form action="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=channels&layout=add&tmpl=component'); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
        ...
        <?php if (empty($this->users)) : ?>
                ...
                <div class="alert alert-info">
                        <?php echo JText::_('COM_HWDMS_MSG_NO_USERS_FOR_NEW_CHANNELS'); ?>
                </div>    
        <?php else : ?>
                <table class="table table-striped table-condensed">
                        <thead>
                                <tr>
                                        ...
                                        <th>
                                                <a class="label" href="javascript:void(0);" onclick="Joomla.submitbutton('channel.create')">
                                                        <strong><?php echo JText::_('COM_HWDMS_BTN_CREATE_SELECTED_CHANNELS') ?></strong>
                                                </a>                                  
                                        </th>
                                </tr>
                        </thead>
                                ...
                                <tr class="row<?php echo $i % 2; ?>">
                                        ...
                                        <td>
                                                <div class="btn-wrapper pull-right">
                                                        <a class="btn" href="javascript:void(0);" onclick="return listItemTask('cb<?php echo $i; ?>','channel.create')"><?php echo JText::_('COM_HWDMS_BTN_ADD_CHANNEL'); ?></a>
                                                </div>                                    
