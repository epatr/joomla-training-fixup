...
?>
<form action="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=linkedresponses&tmpl=component&media_id='.$this->mediaId.'&add=0'); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
