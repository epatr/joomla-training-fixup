...
?>
<form action="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=linkedmedia&tmpl=component&media_id='.$this->mediaId.'&add=0'); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
		...
		<div class="btn-toolbar">
			...
			<div class="btn-group pull-left">
                                <a class="btn btn-info" href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=linkedmedia&tmpl=component&media_id='.$this->mediaId.'&add=1'); ?>">
					<i class="icon-plus"></i><?php echo '&#160;' . JText::_('COM_HWDMS_BTN_LINK_WITH_MORE_MEDIA'); ?></a>
			</div>
