...
<div class="row-fluid">
        <div class="span6">
                <fieldset class="form-horizontal">
                        ...
                        <p class="alert alert-info"><?php echo JText::_('COM_HWDMS_GLOBAL_LIST_LAYOUT_STRUCTURE_DESC'); ?></p>
                        ...
                        <p class="alert alert-info"><?php echo JText::_('COM_HWDMS_GLOBAL_LIST_LAYOUT_ITEM_DESC'); ?></p>
                        <div class="control-group">
                        ...
                        <p class="alert alert-info"><?php echo JText::_('COM_HWDMS_GLOBAL_LIST_LAYOUT_HEADER_DESC'); ?></p>
                        <div class="control-group">
                                <div class="control-label"><?php echo $this->form->getLabel('list_page_title'); ?></div>
                                <div class="controls"><?php echo $this->form->getInput('list_page_title'); ?></div>
                        </div>    
                        <div class="control-group">
                                <div class="control-label"><?php echo $this->form->getLabel('list_feature_button'); ?></div>
                                <div class="controls"><?php echo $this->form->getInput('list_feature_button'); ?></div>
                        </div>                          
                        <div class="control-group">
                ...
                <fieldset class="form-horizontal">
                        ...
                        <div class="control-group">
                                <div class="control-label"><?php echo $this->form->getLabel('category_list_meta_media_count'); ?></div>
                                <div class="controls"><?php echo $this->form->getInput('category_list_meta_media_count'); ?></div>
                        </div>                         
                        <div class="control-group">
        ...
        <div class="span6">
                <fieldset class="form-horizontal">
                        ...
                        <p class="alert alert-info"><?php echo JText::_('COM_HWDMS_GLOBAL_ITEM_LAYOUT_DESC'); ?></p>
                        <div class="control-group">
                ...
                <fieldset class="form-horizontal">
                        ...
                        <p class="alert alert-info"><?php echo JText::_('COM_HWDMS_GLOBAL_MEDIA_ITEM_LAYOUT_DESC'); ?></p>
                        <div class="control-group">
                        ...
                        <div class="control-group"> 
                                <div class="control-label"><?php echo $this->form->getLabel('mediaitem_location_button'); ?></div>
                                <div class="controls"><?php echo $this->form->getInput('mediaitem_location_button'); ?></div>
                        </div>                          
                        <div class="control-group">
                        ...
                        <div class="control-group">
                                <div class="control-label"><?php echo $this->form->getLabel('mediaitem_description'); ?></div>
                                <div class="controls"><?php echo $this->form->getInput('mediaitem_description'); ?></div>
                        </div>     
                        <div class="control-group">
                                <div class="control-label"><?php echo $this->form->getLabel('mediaitem_tags'); ?></div>
                                <div class="controls"><?php echo $this->form->getInput('mediaitem_tags'); ?></div>
                        </div>   
                        <div class="control-group">
                                <div class="control-label"><?php echo $this->form->getLabel('mediaitem_associations'); ?></div>
                                <div class="controls"><?php echo $this->form->getInput('mediaitem_associations'); ?></div>
                        </div>   
                        <div class="control-group">
