...
<div class="row-fluid">
        <div class="span6">
                <fieldset class="form-horizontal">
                        ...
                        <div class="control-group">
                                <div class="control-label"><?php echo $this->form->getLabel('category_assignment'); ?></div>
                                <div class="controls"><?php echo $this->form->getInput('category_assignment'); ?></div>
                        </div>                        
                        <div class="control-group">
                        ...
                        <div class="control-group">
                                <div class="control-label"><?php echo $this->form->getLabel('lightbox_mode'); ?></div>
                                <div class="controls"><?php echo $this->form->getInput('lightbox_mode'); ?></div>
                        </div>                        
                        <div class="control-group">
                                <div class="control-label"><?php echo $this->form->getLabel('secret_word'); ?></div>
                                <div class="controls"><?php echo $this->form->getInput('secret_word'); ?></div> 
                        </div>
                </fieldset>
                <fieldset class="form-horizontal">
