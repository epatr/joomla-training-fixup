...
?>
<form action="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=linkedgroups&tmpl=component&media_id='.$this->mediaId.'&add=0'); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
	...
	<table class="table table-striped table-condensed" id="groupsList">
		<tfoot>
			<tr>
				<td>
		...
		<?php foreach ($this->items as $i => $item) : ?>                    
			<tr class="row<?php echo $i % 2; ?>">                     
				<td>
                                        ...
                                        <p><strong><a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&task=group.edit&id=' . $item->id); ?>" title="<?php echo JText::_('JACTION_EDIT'); ?>" target="_blank">
