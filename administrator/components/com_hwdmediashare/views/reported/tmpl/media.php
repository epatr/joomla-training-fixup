...
?>              
<form action="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=reported&layout=media&tmpl=component&id=' . $app->input->get('id', 0, 'integer'));?>" method="post" name="adminForm" id="adminForm" class="form-inline">
		...
		<?php foreach ($this->items as $i => $item) : ?>
			<tr class="row<?php echo $i % 2; ?>">
				<td>  
                                        ...
                                        <p><a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&task=editmedia.edit&id=' . $item->element_id); ?>" title="<?php echo JText::_('JACTION_EDIT'); ?>" target="_blank"><?php echo $this->escape($item->title); ?></a></p>
                                        <div class="small">
