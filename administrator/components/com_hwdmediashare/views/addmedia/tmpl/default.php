        ...
        <div class="row-fluid">
                <div class="<?php echo $this->replace ? 'span12' : 'span9'; ?>">
                        ...
                        <?php if ($this->config->get('enable_uploads_rtmp') == 1) : ?>
                                <?php echo JHtml::_('bootstrap.addSlide', 'hwdmediashare-slider-upload', JText::_('COM_HWDMS_ADD_REMOTE_STREAMS'), 'streams'); ?>
                                        <div class="stream_fields">
                                                <div class="control-group">
                                                        <div class="control-label">
                                                                <label id="jform_source_type_1-lbl" for="jform_source_type_1" class="hide"><?php echo JText::_('COM_HWDMS_STREAM_TYPE'); ?></label>  
                                                        </div>
                                                        <div class="controls">
                                                                <select id="jform_source_type_1" name="jform[source_type][1]">
                                                                        <option value="1"><?php echo JText::_('COM_HWDMS_STREAMTYPE_RTMP'); ?></option>
                                                                        <option value="2"><?php echo JText::_('COM_HWDMS_STREAMTYPE_HLS'); ?></option>
                                                                        <option value="3"><?php echo JText::_('COM_HWDMS_STREAMTYPE_MP4'); ?></option>                                                                
                                                                </select>                                                    
                                                        </div>
                                                </div>    
                                                <div class="control-group">
                                                        <div class="control-label">
                                                                <label id="jform_source_quality_1-lbl" for="jform_source_quality_1" class="hide"><?php echo JText::_('COM_HWDMS_STREAM_QUALITY'); ?></label>  
                                                        </div>
                                                        <div class="controls">
                                                                <select id="jform_source_quality_1" name="jform[source_quality][1]">
                                                ...
                                                <div class="control-group">
                                                        <div class="control-label">
                                                                <label id="jform_source_url_1-lbl" for="jform_source_url_1" class="hide"><?php echo JText::_('COM_HWDMS_STREAM_URL'); ?></label>  
                                                        </div>
                                                        <div class="controls">
                                                                <input type="text" name="jform[source_url][1]" id="jform_source_url_1" value="" size="40" placeholder="<?php echo JText::_('COM_HWDMS_STREAM_URL'); ?>" />                                                     
                                                        </div>
                                                </div>
                                                <hr />
                                        </div> 
                                        <div class="btn-group">
                                                <button type="button" class="btn add_field_button" onclick="javascript:void(0)">
                                                        <?php echo JText::_('COM_HWDMS_BUTTON_ADD_MORE_SOURCES') ?>
                                                </button>                                            
                                                <button type="button" class="btn btn-info" onclick="Joomla.submitbutton('addmedia.stream')">
                                                        <?php echo JText::_('COM_HWDMS_ADD') ?>
                                                </button>
                                        </div> 
                                        <p></p>
