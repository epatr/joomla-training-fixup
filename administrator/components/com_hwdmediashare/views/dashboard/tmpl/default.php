...
<?php if (!empty($this->sidebar)) : ?>
	<div id="j-sidebar-container" class="span2">
                <div class="hwd-sidebar-dashboard">
                        ...
                        <p><?php echo JText::_('COM_HWDMS_WELCOME_STATEMENT_SUPPORT');?></p>
                </div>                
	...
	<div class="span4">
                <div class="well well-small">
                        ...
                        <div class="row-striped">
                                ...
                                <div class="row-fluid">
                                        <div class="span12">
                                                <a href="index.php?option=com_hwdmediashare&view=channels"><i class="icon-user"></i> <span><?php echo JText::sprintf('COM_HWDMS_CHANNELS_COUNTN', $this->numchannels); ?></span></a>
                                        </div>
                                </div>
                                <div class="row-fluid">
                                        <div class="span12">
