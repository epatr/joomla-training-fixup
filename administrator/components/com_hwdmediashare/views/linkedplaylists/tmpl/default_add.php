...
?>
<form action="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=linkedplaylists&tmpl=component&media_id='.$this->mediaId.'&add=1'); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
		...
		<div class="btn-toolbar">
			...
			<div class="btn-group pull-left">
                                <a class="btn btn-info" href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=linkedplaylists&tmpl=component&media_id='.$this->mediaId.'&add=0'); ?>">
	...
	<table class="table table-striped table-condensed">
		<thead>
			<tr>
                                ...
                                <th>
                                        <a class="label" href="javascript:void(0);" onclick="Joomla.submitbutton('linkedplaylists.link')">
