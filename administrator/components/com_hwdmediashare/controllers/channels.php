...
class hwdMediaShareControllerChannels extends JControllerAdmin
{
	/**
	 ...
	 */
	public function getModel($name = 'Channel', $prefix = 'hwdMediaShareModel', $config = array())
	{
	...
	/**
	 * Method to toggle the status setting of a list of channels.
	 *
	 * @access  public
         * @return  void
	 */
	...
	/**
	 * Method to toggle the featured setting of a list of channels.
	 *
	 * @access  public
         * @return  void
	 */
