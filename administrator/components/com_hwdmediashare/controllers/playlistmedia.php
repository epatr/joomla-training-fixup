...
class hwdMediaShareControllerPlaylistMedia extends JControllerAdmin
{
	 ...
	 */
	public function getModel($name = 'PlaylistMediaItem', $prefix = 'hwdMediaShareModel', $config = array())
	{
	...
	public function unlink()
	{
		...
		$playlistId = $this->input->get('playlist_id', '', 'int');
		...
		$this->setRedirect(JRoute::_('index.php?option=' . $this->option . '&view=' . $this->view_list . '&tmpl=component&playlist_id=' . $playlistId . '&add=' . $add, false));
	}
