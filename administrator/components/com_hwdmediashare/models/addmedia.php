...
class hwdMediaShareModelAddMedia extends JModelAdmin
{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		$form = $this->loadForm('com_hwdmediashare.upload', 'upload', array('control' => 'jform', 'load_data' => $loadData));
                ...
                if ($config->get('category_assignment') == 0)
                {
                        $form->setFieldAttribute('catid', 'multiple', false); 
	...
	public function getFancyUploadScript()
	{
		...
		$app = JFactory::getApplication();
                ...
                $js[] = 'window.hwdms_text_progressOverall = "' . JText::_('COM_HWDMS_FANCY_PROGRESSOVERALL') . '";';
                $js[] = 'window.hwdms_text_currentTitle = "' . JText::_('COM_HWDMS_FANCY_CURRENTTITLE') . '";';
                $js[] = 'window.hwdms_text_currentFile = "' . JText::_('COM_HWDMS_FANCY_CURRENTFILE') . '";';
                $js[] = 'window.hwdms_text_currentProgress = "' . JText::_('COM_HWDMS_FANCY_CURRENTPROGRESS') . '";';
                $js[] = 'window.hwdms_text_uploadComplete = "' . JText::_('COM_HWDMS_FANCY_UPLOADCOMPLETE') . '";';
                $js[] = 'window.hwdms_text_fileName = "' . JText::_('COM_HWDMS_FANCY_FILENAME') . '";';
                $js[] = 'window.hwdms_text_remove = "' . JText::_('COM_HWDMS_FANCY_REMOVE') . '";';
                $js[] = 'window.hwdms_text_removeTitle = "' . JText::_('COM_HWDMS_FANCY_REMOVETITLE') . '";';
                $js[] = 'window.hwdms_text_fileError = "' . JText::_('COM_HWDMS_FANCY_FILEERROR') . '";';
                
                $js[] = 'window.hwdms_text_validationErrors = {sizeLimitMax:"' . JText::_('COM_HWDMS_FANCY_SIZELIMITMAX') . '", fileListSizeMax:""};';
                
                $js[] = 'window.hwdms_text_httpStatus = "' . JText::_('COM_HWDMS_FANCY_HTTPSTATUS') . '";';
                $js[] = 'window.hwdms_text_securityError = "' . JText::_('COM_HWDMS_FANCY_SECURITYERROR') . '";';
                $js[] = 'window.hwdms_text_ioError = "' . JText::_('COM_HWDMS_FANCY_IOERROR') . '";';
                $doc->addScriptDeclaration(implode("\n", $js));  

                JHtml::_('behavior.framework');
                $doc->addScript(JURI::root(true) . "/media/com_hwdmediashare/assets/javascript/Swiff.Uploader.js");
                $doc->addScript(JURI::root(true) . "/media/com_hwdmediashare/assets/javascript/Fx.ProgressBar.js");
                $doc->addScript(JURI::root(true) . "/media/com_hwdmediashare/assets/javascript/FancyUpload2.js");
                $doc->addStyleSheet(JURI::root(true) . "/media/com_hwdmediashare/assets/css/fancy.css");

                $allowedExtensions = $this->getState('allowedExtensions');
                $typeFilter = '\'Media (*.' . implode(', *.', $allowedExtensions) . ')\': \'*.' . implode('; *.', $allowedExtensions) . '\'';
