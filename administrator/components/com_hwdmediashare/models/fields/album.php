...
class JFormFieldAlbum extends JFormField
{
	 ...
	 */
		...
		if ($allowClear && !$scriptClear)
		{
			...
			$script[] = '		document.getElementById(id + "_name").innerHTML = "'.htmlspecialchars(JText::_('COM_HWDMS_SELECT_ALBUM', true), ENT_COMPAT, 'UTF-8').'";';
		...
		$html[] = '<a class="modal btn hasTooltip" title="'.JHtml::tooltipText('COM_HWDMS_CHANGE_ALBUM').'"  href="'.$link.'&amp;'.JSession::getFormToken().'=1" rel="{handler: \'iframe\', size: {x: 800, y: 450}}"><i class="icon-file"></i> '.JText::_('JSELECT').'</a>';
