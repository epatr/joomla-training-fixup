...
class hwdMediaShareModelChannel extends JModelAdmin
{        
	/**
	...
	public function getItem($pk = null)
	{
                if ($item = parent::getItem($pk))
                {
                        ...
                        $item->tags->getTagIds($item->id, 'com_hwdmediashare.channel');
                        ...
                        // Add the channel thumbnail (avatar).
	...
	{
		// Get the form.
		$form = $this->loadForm('com_hwdmediashare.channel', 'channel', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_hwdmediashare.edit.channel.data', array());
