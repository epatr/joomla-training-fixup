...
class Com_ComprofilerInstallerScript {
	...
	public function install( /** @noinspection PhpUnusedParameterInspection */ $parent ) {
		...
		$return									=	'<div style="margin-bottom:10px;width:100%;text-align:center;"><img alt="' . htmlspecialchars( CBTxt::T( 'CB Logo' ) ) . '" src="' . $liveSite . '/components/com_comprofiler/images/smcblogo.gif" /></div>'
												.	'<div style="font-size:14px;margin-bottom:10px;">Copyright 2004-2018 Joomlapolis.com. ' . CBTxt::T( 'This component is released under the GNU/GPL version 2 License. All copyright statements must be kept. Derivate work must prominently duly acknowledge original work and include visible online links.' ) . '</div>';
		...
		if ( cbInstaller_install_plugins( $this, $pluginMessages ) ) {
			// All ok, Nothing to alarm user here-
 ...
 * @return bool
 */
function cbInstaller_install_plugins( $parent, &$return ) {
	global $_CB_framework, $_CB_adminpath, $ueConfig;
