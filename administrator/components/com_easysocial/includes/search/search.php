...
class SocialSearch extends EasySocial
{
	 ...
	 * @access	public
	 */
	public function search($query = '', $limitstart = 0, $limit = 20, $filters = array(), $highlight = true)
	{
	...
	{
		return array(SOCIAL_INDEXER_TYPE_USERS, SOCIAL_INDEXER_TYPE_PHOTOS, SOCIAL_INDEXER_TYPE_ALBUMS, SOCIAL_INDEXER_TYPE_GROUPS, SOCIAL_INDEXER_TYPE_EVENTS, SOCIAL_INDEXER_TYPE_PAGES);
	}
