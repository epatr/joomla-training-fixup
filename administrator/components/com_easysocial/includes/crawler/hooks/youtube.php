...
class SocialCrawlerYoutube extends SocialCrawlerAbstract
{
	...
	public function process(&$result)
	{
		...
		if (stristr($this->url, 'youtube.com') === false) {
			return;
		}
	...
	public function simulateOembed()
	{
		...
		$oembed->thumbnail = 'http://img.youtube.com/vi/'. $id .'/sddefault.jpg';
		$oembed->thumbnail_url = 'http://img.youtube.com/vi/'. $id .'/sddefault.jpg';	
