...
class ThemesHelperAvatar extends ThemesHelperAbstract
{
	 ...
	 * @access	public
	 */
	public function cluster($cluster, $size = 'default', $popbox = true, $showOnlineState = false, $popboxPosition = '', $anchorLink = true)
	{
		static $cache = array();

		$index = $cluster->id . $size . (int) $popbox . (int) $showOnlineState . $popboxPosition . (int) $anchorLink;
