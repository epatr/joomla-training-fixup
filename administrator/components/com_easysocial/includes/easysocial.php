	...
	public static function checkCompleteProfile()
	{
		...
		if ($percentage < 100) {
			...
			if ($action === 'redirect') {
				...
				FD::info()->set(false , JText::sprintf('COM_EASYSOCIAL_PROFILE_YOUR_PROFILE_IS_INCOMPLETE_ENFORCED', $percentage) , SOCIAL_MSG_INFO);

				$mainframe->redirect(FRoute::profile(array('layout' => 'edit'), false));
			}
