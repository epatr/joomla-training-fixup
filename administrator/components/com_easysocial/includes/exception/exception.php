...
class SocialException
{
	...
	private function parse($message='', $type = ES_ERROR)
	{
		switch ($type) {
	...
	private function set($message='', $type = ES_ERROR)
	{
		// Translate messages
	...
	public static function factory($message='', $type = ES_ERROR)
	{
