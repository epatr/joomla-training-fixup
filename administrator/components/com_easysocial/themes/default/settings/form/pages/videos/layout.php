		...
		<div class="panel">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-md-7">
						<?php echo $this->html('form.toggler', 'video.layout.item.recent', $this->config->get('video.layout.item.recent')); ?>
					</div>
				</div>
		...
		<div class="panel">
			...
			<div class="panel-body">
				...
				<div class="form-group <?php echo $this->config->get('video.layout.player.watermark') ? '' : 't-hidden';?>" data-watermark-form>
					<?php echo $this->html('panel.label', 'COM_ES_VIDEO_PLAYER_WATERMARK_IMAGE'); ?>
