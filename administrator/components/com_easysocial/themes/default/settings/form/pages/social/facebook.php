				...
				<div class="form-group">
					...
					<div class="col-md-7">
						...
						<div class="o-input-group mb-10">
							<input type="text" data-oauthuri-input id="oauth-uri" name="oauth-uri" value="<?php echo rtrim(JURI::root(), '/') . '/index.php?option=com_easysocial&view=registration&layout=oauthDialog&client=facebook';?>" class="o-form-control" size="60" style="pointer-events:none;" />
						...
						<div class="o-input-group mb-10">
							<input type="text" data-oauthuri-input id="oauth-uri-2" name="oauth-uri-2" value="<?php echo rtrim(JURI::root(), '/') . '/index.php?option=com_easysocial&view=registration&layout=oauthLogin&client=facebook';?>" class="o-form-control" size="60" style="pointer-events:none;" />
