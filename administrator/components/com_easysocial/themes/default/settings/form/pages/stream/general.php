...
<div class="row">
	...
	<div class="col-md-6">
		<div class="panel">
			<?php echo $this->html('panel.heading', 'COM_ES_STREAM_SETTING_FILTERING'); ?>

			<div class="panel-body">

				<div class="form-group">
					<?php echo $this->html('panel.label', 'COM_ES_STREAM_SETTING_FILTER_APPS'); ?>

					<div class="col-md-7">
						<?php echo $this->html('grid.selectlist', 'stream.filter.apps', $this->config->get('stream.filter.apps'), array(
								array('value' => 'me', 'text' => 'COM_ES_STREAM_SETTING_FILTER_APPS_TYPE_ME'),
								array('value' => 'everyone', 'text' => 'COM_ES_STREAM_SETTING_FILTER_APPS_TYPE_EVERYONE')
							)); ?>
					</div>
				</div>
