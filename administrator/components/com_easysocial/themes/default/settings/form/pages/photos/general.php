		...
		<div class="panel">
			...
			<div class="panel-body">
				<div class="form-group">
					<?php echo $this->html('panel.label', 'COM_EASYSOCIAL_PHOTOS_SETTINGS_ENABLE_PHOTOS'); ?>

					<div class="col-md-7">
						<?php echo $this->html('form.toggler', 'photos.enabled', $this->config->get('photos.enabled')); ?>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<?php echo $this->html('panel.label', 'COM_ES_PHOTOS_SETTINGS_ALLOW_LOCATION'); ?>

					<div class="col-md-7">
						<?php echo $this->html('form.toggler', 'photos.location', $this->config->get('photos.location')); ?>
					</div>
				</div>

				<div class="form-group">
					<?php echo $this->html('panel.label', 'COM_EASYSOCIAL_PHOTOS_SETTINGS_IMPORT_EXIF_DATA'); ?>

					<div class="col-md-7">
						<?php echo $this->html('form.toggler', 'photos.import.exif', $this->config->get('photos.import.exif')); ?>
					</div>
				</div>
				
				<div class="form-group">
					<?php echo $this->html('panel.label', 'COM_EASYSOCIAL_PHOTOS_SETTINGS_ALLOW_VIEW_ORIGINAL'); ?>

					<div class="col-md-7">
						<?php echo $this->html('form.toggler', 'photos.original', $this->config->get('photos.original')); ?>
					</div>
				</div>

				<div class="form-group">
					<?php echo $this->html('panel.label', 'COM_EASYSOCIAL_PHOTOS_SETTINGS_ALLOW_DOWNLOADS'); ?>

					<div class="col-md-7">
						<?php echo $this->html('form.toggler', 'photos.downloads', $this->config->get('photos.downloads')); ?>
					</div>
				</div>
