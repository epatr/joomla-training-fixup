	...
	<div class="col-md-6">
		<div class="panel">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<?php echo $this->html('panel.label', 'COM_EASYSOCIAL_USERS_SETTINGS_ALLOW_USER_BLOCKING'); ?>

					<div class="col-md-7">
						<?php echo $this->html('form.toggler', 'users.blocking.enabled', $this->config->get('users.blocking.enabled')); ?>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-7">
						<?php echo $this->html('form.toggler', 'users.avatarWebcam', $this->config->get('users.avatarWebcam'));?>
					</div>
				</div>

				<div class="form-group">
					<?php echo $this->html('panel.label', 'COM_ES_USERS_SETTINGS_ALLOW_USER_DOWNLOAD'); ?>

					<div class="col-md-7">
						<?php echo $this->html('form.toggler', 'users.download.enabled', $this->config->get('users.download.enabled')); ?>
					</div>
				</div>
