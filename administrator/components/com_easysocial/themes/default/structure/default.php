...
<div id="es" class="es-backend <?php echo $class;?>">
	...
	<div class="app-alert o-alert o-alert--danger t-hidden" style="margin-bottom: 0;padding: 15px 24px;font-size: 12px;" data-outdated-banner>
		<div class="row-table">
			...
			<div class="col-cell cell-tight">
				<a href="<?php echo JRoute::_('index.php?option=com_easysocial&launchInstaller=1');?>" class="btn btn-es-default">
	...
	<div class="app-alert app-devmode is-on alert warning">
		<div class="row-table">
			<div class="col-cell cell-tight">
				<i class="fa fa-info-circle"></i>
			</div>
			<div class="col-cell pl-10 pr-10">
				<?php echo JText::_('COM_EASYSOCIAL_CURRENTLY_ON_DEVELOPMENT');?>
			</div>
			<div class="col-cell cell-tight">
				<a href="<?php echo JRoute::_('index.php?option=com_easysocial&view=settings&layout=form&page=general&tab=system');?>" class="btn btn-es-danger">
					<b><i class="fa fa-cog"></i>&nbsp; <?php echo JText::_('COM_EASYSOCIAL_CONFIGURE_BUTTON');?></b>
				</a>
			</div>
		</div>
	</div>
