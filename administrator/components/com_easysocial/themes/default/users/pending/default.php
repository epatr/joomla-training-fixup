		...
		<table class="app-table table" data-pending-users>
			...
			<?php if( $users ){ ?>
				...
				<tr data-pending-item
					...
					<td align="left">
						<i class="fa fa-<?php echo $user->type;?> t-lg-mr--md" data-es-provide="tooltip" data-original-title="<?php echo JText::sprintf('COM_EASYSOCIAL_USERS_USER_ACCOUNT_TYPE', $user->type);?>"></i>
