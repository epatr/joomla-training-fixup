...
<form name="adminForm" id="adminForm" class="esForm" action="index.php" method="post" data-table-grid>
	...
	<div class="app-filter-bar">
		<div class="t-lg-p--md">
			<?php echo JText::_('COM_EASYSOCIAL_MAILER_DESCRIPTION'); ?> 
			<a href="https://stackideas.com/docs/easysocial/administrators/cronjobs/cronjobs" target="_blank" class="btn btn-es-default-o btn-sm t-lg-ml--xl"><?php echo JText::_('COM_EASYSOCIAL_LEARN_MORE'); ?></a>
		</div>
	</div>
