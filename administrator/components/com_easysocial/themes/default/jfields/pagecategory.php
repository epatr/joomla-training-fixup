...
<span class="input-append">
	<input type="text" class="input-medium" disabled="disabled" size="35" value="<?php echo JText::_($label); ?>" data-jfield-pagecategory-title />
	<a href="javascript:void(0);" class="btn btn-default" data-jfield-pagecategory>
