					...
					<div class="col-md-7">
						...
						<div>
							...
							<span data-category-avatar-remove-wrap <?php if(!$category->hasAvatar()) { ?>style="display: none;"<?php } ?>>
								...
								<a href="javascript:void(0);" class="btn btn-es-danger btn-sm" data-id="<?php echo $category->id;?>" data-category-avatar-remove-button><i class="fa fa-remove"></i> <?php echo JText::_('COM_ES_FORM_REMOVE_AVATAR'); ?></a>
							</span>
						</div>
					</div>
				</div>
