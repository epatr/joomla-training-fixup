...
class RADForm
{
	...
	public function validate($prefix = '')
	{
		...
		foreach ($fields as $field)
		{
			...
			// Ignore State validation since some country doesn't have state available
			if ($field->type == 'State')
			{
				continue;
			}
	...
	{
		$fieldsFee     = array();
		$feeFieldTypes = array('text', 'radio', 'list', 'checkboxes', 'hidden');
		...
		foreach ($this->fields as $fieldName => $field)
		{
			...
			{
				if (in_array($fieldType, ['text', 'hidden']))
				{
