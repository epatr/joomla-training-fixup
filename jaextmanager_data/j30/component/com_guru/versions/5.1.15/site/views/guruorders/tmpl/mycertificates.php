                                    ...
                                    <td class="g_cell_1"> 
                                        <?php
                                            ...
                                            if(!isset($date_completed)){
                                                ...
                                                $sql = "select count(*) from #__guru_mycertificates where `course_id`=".intval($course["course_id"])." and `author_id`=".intval($certificate_course_author)." and `user_id`=".intval($joomla_user->id)." and `completed`='1'";
                                                $db->setQuery($sql);
                                                $db->execute();
                                                ...
                                                if(intval($count_certificates) == 0){
                                                    $sql = 'insert into #__guru_mycertificates (`course_id`, `author_id`, `user_id`, `emailcert`, `datecertificate`, `completed`) values ("'.intval($course["course_id"]).'", "'.intval($certificate_course_author).'", "'.intval($joomla_user->id).'", \'0\', "'.$date_completed.'", "1")';
                                                    $db->setQuery($sql);
                                                    $db->execute();
                                                }*/
                                            }
