...
class RegistryEditController {
	 ...
	 */
	public function __construct( InputInterface $input, DatabaseDriverInterface $db, RegistryInterface $registry, SimpleXMLElement $xmlElement = null, SimpleXMLElement $xml = null, PluginTable $pluginObject = null, $tabId = null, $maintagname = 'cbinstall', $attrname = 'type', $attrvalue = 'plugin'  )
	{
		$this->input			=	$input;
		$this->_db				=	$db;
	 ...
	 * @return self                          For chaining
	 */
	public function setPluginParams( RegistryInterface $pluginParams ) {
	 ...
	 * @return self                          For chaining
	 */
	public function setExtendedViewParser( SimpleXMLElement $extendedViewParser ) {
	 ...
	 */
	public function getEditedParams( ) {
	 ...
	 */
	public function draw( $tag_path='params', $grand_parent_path=null, $parent_tag=null, $parent_attr=null, $parent_attrvalue=null, $control_name='params', $paramstextarea=true, $viewType = 'depends', $htmlFormatting = 'div'  ) {
