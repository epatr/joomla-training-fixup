	...
	static function loadValidation( $selector = '.cbValidation' )
	{
		...
		if ( ! $options ) {
			...
			$messages				=	array(	'required' => addslashes( CBTxt::T( 'VALIDATION_ERROR_FIELD_REQUIRED', 'This field is required.' ) ),
													...
													'maxage' => addslashes( CBTxt::T( 'VALIDATION_ERROR_FIELD_MAX_AGE', 'You must be no more than {0} years old.' ) ),
													'minage' => addslashes( CBTxt::T( 'VALIDATION_ERROR_FIELD_MIN_AGE', 'You must be at least {0} years old.' ) ),
													'rangeage' => addslashes( CBTxt::T( 'VALIDATION_ERROR_FIELD_AGE_RANGE', 'You must be at least {0} years old, but not older than {1}.' ) ),
