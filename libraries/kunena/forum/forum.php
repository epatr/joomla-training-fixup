...
abstract class KunenaForum
{
	...
	protected static function buildVersion()
	{
		if ('5.0.14' == '@' . 'kunenaversion' . '@')
		{
			...
			{
				self::$version = strtoupper('5.0.14');
			}
		}
		else
		{
		...
		self::$version_date = ('2018-03-14' == '@' . 'kunenaversiondate' . '@') ? JFactory::getDate()->format('Y-m-d') : '2018-03-14';
		self::$version_name = ('Stephen Hawking' == '@' . 'kunenaversionname' . '@') ? 'Git Repository' : 'Stephen Hawking';
	}
}
